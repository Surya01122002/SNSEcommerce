<?php
 ...
 $familydetail=get_safe_value($con,$_POST['familydetail']);
 $clg_name=get_safe_value($con,$_POST['clg_name']);
 $clg_reg_number=get_safe_value($con,$_POST['clg_reg_number']);
 ...
 $family_id=get_safe_value($con,$_POST['family_id']);
